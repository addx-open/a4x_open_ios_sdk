...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/A4xVideoPushManager/A4xVideoPushManager.framework"
  install_framework "${PODS_ROOT}/../A4xWebRtcFramework/Frameworks/WebRTC.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/A4xWebRtcFramework/A4xWebRtcFramework.framework"
